// recovered from: C:\Users\ufop\Downloads\192.168.8.17_8000\19.53_RunTime_AonB\??\p1612\framework__appspawn-x__src__main.cpp@262.html
// title: p1612 framework/appspawn-x/src/main.cpp:262
  ...
  270:         if (pid == 0) {
  271:             // ---- Child process ----
  272:             // Close the listening socket (child doesn't accept connections)
  273:             server.closeSocket();
  274:  
