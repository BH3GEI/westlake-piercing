...
// Stub of the Khronos vulkan/vulkan_android.h for the OpenHarmony bringup
// build (the OHOS SDK ships vulkan_ohos.h instead). Declarations mirror the
// official header; the loader entry points are never linked in the smoke
// build.
