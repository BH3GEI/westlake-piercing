...
.method public static blacklist codec2_hal_selection()Ljava/util/Optional;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 201
    const-string/jumbo v0, "media.c2.hal.selection"
    ...
    .line 202
    .local v0, "value":Ljava/lang/String;
    const-class v1, Landroid/sysprop/MediaProperties$codec2_hal_selection_values;

    invoke-static {v1, v0}, Landroid/sysprop/MediaProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object v1

    check-cast v1, Landroid/sysprop/MediaProperties$codec2_hal_selection_values;
...
.method public static blacklist codec2_remove_rendering_depth()Ljava/util/Optional;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 206
    const-string/jumbo v0, "media.c2.remove_rendering_depth"
    ...
    .line 207
    .local v0, "value":Ljava/lang/String;
    invoke-static {v0}, Landroid/sysprop/MediaProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
