...
.method public static blacklist fromList(Ljava/util/List;Landroid/net/vcn/util/PersistableBundleUtils$Serializer;)Landroid/os/PersistableBundle;
    ...
    .local p1, "serializer":Landroid/net/vcn/util/PersistableBundleUtils$Serializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Serializer<TT;>;"
    new-instance v0, Landroid/os/PersistableBundle;
...
.method public static blacklist fromMap(Ljava/util/Map;Landroid/net/vcn/util/PersistableBundleUtils$Serializer;Landroid/net/vcn/util/PersistableBundleUtils$Serializer;)Landroid/os/PersistableBundle;
    ...
    .local p1, "keySerializer":Landroid/net/vcn/util/PersistableBundleUtils$Serializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Serializer<TK;>;"
    .local p2, "valueSerializer":Landroid/net/vcn/util/PersistableBundleUtils$Serializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Serializer<TV;>;"
    new-instance v0, Landroid/os/PersistableBundle;
    ...
    invoke-interface {p1, v6}, Landroid/net/vcn/util/PersistableBundleUtils$Serializer;->toPersistableBundle(Ljava/lang/Object;)Landroid/os/PersistableBundle;
    ...
    invoke-interface {p2, v6}, Landroid/net/vcn/util/PersistableBundleUtils$Serializer;->toPersistableBundle(Ljava/lang/Object;)Landroid/os/PersistableBundle;
...
.method public static blacklist getHashCode(Landroid/os/PersistableBundle;)I
    ...
    invoke-static {v6}, Landroid/net/vcn/util/PersistableBundleUtils;->getHashCode(Landroid/os/PersistableBundle;)I
...
.method public static blacklist isEqual(Landroid/os/PersistableBundle;Landroid/os/PersistableBundle;)Z
    ...
    invoke-static {v6, v7}, Landroid/net/vcn/util/PersistableBundleUtils;->isEqual(Landroid/os/PersistableBundle;Landroid/os/PersistableBundle;)Z
...
.method public static blacklist toByteArray(Landroid/os/PersistableBundle;)[B
    ...
    .line 222
    invoke-static {v0}, Lcom/android/net/module/util/HexDump;->hexStringToByteArray(Ljava/lang/String;)[B
...
.method public static blacklist toList(Landroid/os/PersistableBundle;Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;)Ljava/util/List;
    ...
    .line 176
    .local p1, "deserializer":Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Deserializer<TT;>;"
    ...
    invoke-interface {p1, v4}, Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;->fromPersistableBundle(Landroid/os/PersistableBundle;)Ljava/lang/Object;
...
.method public static blacklist toMap(Landroid/os/PersistableBundle;Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;)Ljava/util/LinkedHashMap;
    ...
    .line 284
    .local p1, "keyDeserializer":Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Deserializer<TK;>;"
    .local p2, "valueDeserializer":Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;, "Landroid/net/vcn/util/PersistableBundleUtils$Deserializer<TV;>;"
    const-string v0, "COLLECTION_LENGTH"
    ...
    invoke-interface {p1, v5}, Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;->fromPersistableBundle(Landroid/os/PersistableBundle;)Ljava/lang/Object;

    move-result-object v7

    .line 294
    .local v7, "key":Ljava/lang/Object;, "TK;"
    invoke-interface {p2, v6}, Landroid/net/vcn/util/PersistableBundleUtils$Deserializer;->fromPersistableBundle(Landroid/os/PersistableBundle;)Ljava/lang/Object;
