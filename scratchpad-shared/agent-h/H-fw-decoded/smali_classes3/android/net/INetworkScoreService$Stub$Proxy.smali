...
.method public greylist-max-o clearScores()Z
    ...
    .line 382
    invoke-virtual {p0}, Landroid/net/INetworkScoreService$Stub$Proxy;->asBinder()Landroid/os/IBinder;
...
.method public greylist-max-o getAllValidScorers()Ljava/util/List;
    ...
    .line 601
    .end local v2    # "_status":Z
    .local v3, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/net/NetworkScorerAppData;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 601
    .end local v3    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/net/NetworkScorerAppData;>;"
    :catchall_0
    move-exception v2
