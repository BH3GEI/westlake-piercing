...
.method public blacklist onError(Ljava/lang/Exception;)V
    ...
    .line 161
    :try_start_0
    iget-object v0, p0, Landroid/service/settings/preferences/SettingsPreferenceService$1$3;->val$callback:Landroid/service/settings/preferences/ISetValueCallback;

    invoke-interface {v0}, Landroid/service/settings/preferences/ISetValueCallback;->onFailure()V
    :try_end_0
...
.method public blacklist onResult(Landroid/service/settings/preferences/SetValueResult;)V
    ...
    invoke-interface {v0, p1}, Landroid/service/settings/preferences/ISetValueCallback;->onSuccess(Landroid/service/settings/preferences/SetValueResult;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
