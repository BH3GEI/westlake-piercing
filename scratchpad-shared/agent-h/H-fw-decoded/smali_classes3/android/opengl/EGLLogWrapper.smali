...
.method public whitelist eglChooseConfig(Ljavax/microedition/khronos/egl/EGLDisplay;[I[Ljavax/microedition/khronos/egl/EGLConfig;I[I)Z
    ...
    .end local p1    # "display":Ljavax/microedition/khronos/egl/EGLDisplay;
    .end local p2    # "attrib_list":[I
    .end local p3    # "configs":[Ljavax/microedition/khronos/egl/EGLConfig;
    .end local p4    # "config_size":I
    .end local p5    # "num_config":[I
    .local v2, "display":Ljavax/microedition/khronos/egl/EGLDisplay;
    .local v3, "attrib_list":[I
    .local v4, "configs":[Ljavax/microedition/khronos/egl/EGLConfig;
    .local v5, "config_size":I
    .local v6, "num_config":[I
    ...
    invoke-direct {p0, p2, v4}, Landroid/opengl/EGLLogWrapper;->arg(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 58
    const-string/jumbo p2, "num_config"

    invoke-direct {p0, p2, v6}, Landroid/opengl/EGLLogWrapper;->arg(Ljava/lang/String;[I)V

    .line 59
    invoke-direct {p0, p1}, Landroid/opengl/EGLLogWrapper;->returns(Z)V
