...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/media/tv/extension/scan/IScanInterface;
    ...
    check-cast v1, Landroid/media/tv/extension/scan/IScanInterface;

    return-object v1

    .line 51
    :cond_1
    new-instance v1, Landroid/media/tv/extension/scan/IScanInterface$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/media/tv/extension/scan/IScanInterface$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 120
    invoke-virtual {p0, v2, v3, v4, v5}, Landroid/media/tv/extension/scan/IScanInterface$Stub;->getParameters(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {v5}, Landroid/media/tv/extension/scan/IScanListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/tv/extension/scan/IScanListener;

    move-result-object v5

    .line 103
    .local v5, "_arg3":Landroid/media/tv/extension/scan/IScanListener;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 104
    invoke-virtual {p0, v2, v3, v4, v5}, Landroid/media/tv/extension/scan/IScanInterface$Stub;->createSession(ILjava/lang/String;Ljava/lang/String;Landroid/media/tv/extension/scan/IScanListener;)Landroid/os/IBinder;
    ...
    .end local v3    # "_arg1":Ljava/lang/String;
    .end local v4    # "_arg2":Ljava/lang/String;
    .end local v5    # "_arg3":Landroid/media/tv/extension/scan/IScanListener;
