...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback;
    ...
    check-cast v1, Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback;

    return-object v1

    .line 66
    :cond_1
    new-instance v1, Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    .line 83
    :pswitch_0
    const-string v0, "onAccessConfigurationChanged"

    return-object v0

    .line 79
    :pswitch_1
    const-string v0, "onAccessAllowedStateChanged"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 119
    :pswitch_0
    sget-object v2, Landroid/telephony/satellite/SatelliteAccessConfiguration;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v2}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/telephony/satellite/SatelliteAccessConfiguration;

    .line 120
    .local v2, "_arg0":Landroid/telephony/satellite/SatelliteAccessConfiguration;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 121
    invoke-virtual {p0, v2}, Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback$Stub;->onAccessConfigurationChanged(Landroid/telephony/satellite/SatelliteAccessConfiguration;)V

    .line 122
    goto :goto_0

    .line 111
    .end local v2    # "_arg0":Landroid/telephony/satellite/SatelliteAccessConfiguration;
    :pswitch_1
    ...
    .line 113
    invoke-virtual {p0, v2}, Landroid/telephony/satellite/ISatelliteCommunicationAccessStateCallback$Stub;->onAccessAllowedStateChanged(Z)V
