...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/telephony/satellite/SatelliteManager;->requestIsCommunicationAllowedForCurrentLocation(Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
.end annotation
...
.method static synthetic blacklist lambda$onReceiveResult$0(Landroid/os/OutcomeReceiver;Z)V
    ...
    .param p1, "isSatelliteCommunicationAllowed"    # Z
...
.method static synthetic blacklist lambda$onReceiveResult$1(Landroid/os/OutcomeReceiver;Z)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda4;-><init>(Landroid/os/OutcomeReceiver;Z)V
...
.method static synthetic blacklist lambda$onReceiveResult$3(Landroid/os/OutcomeReceiver;)V
    ...
    .line 2397
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda3;

    invoke-direct {v0, p0}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda3;-><init>(Landroid/os/OutcomeReceiver;)V
...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    .line 2390
    const-string/jumbo v0, "satellite_communication_allowed"
    ...
    .line 2393
    .local v0, "isSatelliteCommunicationAllowed":Z
    ...
    new-instance v3, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2, v0}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda0;-><init>(Landroid/os/OutcomeReceiver;Z)V

    invoke-interface {v1, v3}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    .line 2395
    .end local v0    # "isSatelliteCommunicationAllowed":Z
    goto :goto_0

    .line 2396
    :cond_0
    const-string v0, "KEY_SATELLITE_COMMUNICATION_ALLOWED does not exist."
    ...
    new-instance v2, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda1;

    invoke-direct {v2, v1}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda1;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    invoke-direct {v2, v1, p1}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda2;-><init>(Landroid/os/OutcomeReceiver;I)V
