...
.method public constructor blacklist <init>(Ljava/util/function/BiPredicate;)V
    ...
    .line 16
    .local p1, "getValueImpl":Ljava/util/function/BiPredicate;, "Ljava/util/function/BiPredicate<Ljava/lang/String;Ljava/util/function/Predicate<Landroid/view/flags/FeatureFlags;>;>;"
    ...
    const-string v44, "android.view.flags.view_velocity_api"
    ...
    const-string v10, "android.view.flags.enable_invalidate_check_thread"

    const-string v11, "android.view.flags.enable_scroll_feedback_for_touch"

    const-string v12, "android.view.flags.enable_surface_native_alloc_registration_ro"

    const-string v13, "android.view.flags.enable_use_measure_cache_during_force_layout"

    const-string v14, "android.view.flags.enable_vector_cursor_a11y_settings"

    const-string v15, "android.view.flags.enable_vector_cursors"

    const-string v16, "android.view.flags.expected_presentation_time_api"

    const-string v17, "android.view.flags.expected_presentation_time_read_only"

    const-string v18, "android.view.flags.scroll_capture_relax_scroll_view_criteria"

    const-string v19, "android.view.flags.scroll_capture_target_z_order_fix"

    const-string v20, "android.view.flags.scroll_feedback_api"

    const-string v21, "android.view.flags.sensitive_content_app_protection"

    const-string v22, "android.view.flags.sensitive_content_app_protection_api"

    const-string v23, "android.view.flags.sensitive_content_premature_protection_removed_fix"

    const-string v24, "android.view.flags.set_frame_rate_callback"

    const-string v25, "android.view.flags.surface_view_get_surface_package"

    const-string v26, "android.view.flags.surface_view_set_composition_order"

    const-string v27, "android.view.flags.toolkit_frame_rate_animation_bugfix_25q1"

    const-string v28, "android.view.flags.toolkit_frame_rate_by_size_read_only"

    const-string v29, "android.view.flags.toolkit_frame_rate_debug"

    const-string v30, "android.view.flags.toolkit_frame_rate_default_normal_read_only"

    const-string v31, "android.view.flags.toolkit_frame_rate_function_enabling_read_only"

    const-string v32, "android.view.flags.toolkit_frame_rate_small_uses_percent_read_only"

    const-string v33, "android.view.flags.toolkit_frame_rate_touch_boost_25q1"

    const-string v34, "android.view.flags.toolkit_frame_rate_typing_read_only"

    const-string v35, "android.view.flags.toolkit_frame_rate_velocity_mapping_read_only"

    const-string v36, "android.view.flags.toolkit_frame_rate_view_enabling_read_only"

    const-string v37, "android.view.flags.toolkit_initial_touch_boost"

    const-string v38, "android.view.flags.toolkit_metrics_for_frame_rate_decision"

    const-string v39, "android.view.flags.toolkit_set_frame_rate"

    const-string v40, "android.view.flags.toolkit_set_frame_rate_read_only"

    const-string v41, "android.view.flags.toolkit_viewgroup_set_requested_frame_rate_api"

    const-string v42, "android.view.flags.use_refactored_round_scrollbar"

    const-string v43, "android.view.flags.use_view_based_rotary_encoder_scroll_haptics"
...
.method public blacklist getFlagNames()Ljava/util/List;
    ...
    .line 338
    const-string v42, "android.view.flags.use_view_based_rotary_encoder_scroll_haptics"

    const-string v43, "android.view.flags.view_velocity_api"
    ...
    const-string v6, "android.view.flags.disable_draw_wake_lock"

    const-string v7, "android.view.flags.dynamic_view_rotary_haptics_configuration"

    const-string v8, "android.view.flags.enable_arrow_icon_on_hover_when_clickable"

    const-string v9, "android.view.flags.enable_invalidate_check_thread"

    const-string v10, "android.view.flags.enable_scroll_feedback_for_touch"

    const-string v11, "android.view.flags.enable_surface_native_alloc_registration_ro"

    const-string v12, "android.view.flags.enable_use_measure_cache_during_force_layout"

    const-string v13, "android.view.flags.enable_vector_cursor_a11y_settings"

    const-string v14, "android.view.flags.enable_vector_cursors"

    const-string v15, "android.view.flags.expected_presentation_time_api"

    const-string v16, "android.view.flags.expected_presentation_time_read_only"

    const-string v17, "android.view.flags.scroll_capture_relax_scroll_view_criteria"

    const-string v18, "android.view.flags.scroll_capture_target_z_order_fix"

    const-string v19, "android.view.flags.scroll_feedback_api"

    const-string v20, "android.view.flags.sensitive_content_app_protection"

    const-string v21, "android.view.flags.sensitive_content_app_protection_api"

    const-string v22, "android.view.flags.sensitive_content_premature_protection_removed_fix"

    const-string v23, "android.view.flags.set_frame_rate_callback"

    const-string v24, "android.view.flags.surface_view_get_surface_package"

    const-string v25, "android.view.flags.surface_view_set_composition_order"

    const-string v26, "android.view.flags.toolkit_frame_rate_animation_bugfix_25q1"

    const-string v27, "android.view.flags.toolkit_frame_rate_by_size_read_only"

    const-string v28, "android.view.flags.toolkit_frame_rate_debug"

    const-string v29, "android.view.flags.toolkit_frame_rate_default_normal_read_only"

    const-string v30, "android.view.flags.toolkit_frame_rate_function_enabling_read_only"

    const-string v31, "android.view.flags.toolkit_frame_rate_small_uses_percent_read_only"

    const-string v32, "android.view.flags.toolkit_frame_rate_touch_boost_25q1"

    const-string v33, "android.view.flags.toolkit_frame_rate_typing_read_only"

    const-string v34, "android.view.flags.toolkit_frame_rate_velocity_mapping_read_only"

    const-string v35, "android.view.flags.toolkit_frame_rate_view_enabling_read_only"

    const-string v36, "android.view.flags.toolkit_initial_touch_boost"

    const-string v37, "android.view.flags.toolkit_metrics_for_frame_rate_decision"

    const-string v38, "android.view.flags.toolkit_set_frame_rate"

    const-string v39, "android.view.flags.toolkit_set_frame_rate_read_only"

    const-string v40, "android.view.flags.toolkit_viewgroup_set_requested_frame_rate_api"

    const-string v41, "android.view.flags.use_refactored_round_scrollbar"
...
.method protected blacklist getValue(Ljava/lang/String;Ljava/util/function/Predicate;)Z
    ...
    .line 334
    .local p2, "getter":Ljava/util/function/Predicate;, "Ljava/util/function/Predicate<Landroid/view/flags/FeatureFlags;>;"
