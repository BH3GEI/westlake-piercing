...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/window/IBackAnimationHandoffHandler;
    ...
    check-cast v1, Landroid/window/IBackAnimationHandoffHandler;

    return-object v1

    .line 56
    :cond_1
    new-instance v1, Landroid/window/IBackAnimationHandoffHandler$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/window/IBackAnimationHandoffHandler$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    .line 69
    :pswitch_0
    const-string v0, "handOffAnimation"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object v3, Landroid/window/WindowAnimationState;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v3}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v3

    check-cast v3, [Landroid/window/WindowAnimationState;

    .line 100
    .local v3, "_arg1":[Landroid/window/WindowAnimationState;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 101
    invoke-virtual {p0, v2, v3}, Landroid/window/IBackAnimationHandoffHandler$Stub;->handOffAnimation([Landroid/view/RemoteAnimationTarget;[Landroid/window/WindowAnimationState;)V
    ...
    .end local v3    # "_arg1":[Landroid/window/WindowAnimationState;
    return v1
