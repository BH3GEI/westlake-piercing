...
.method static blacklist verifyProofOfRotationStruct(Ljava/nio/ByteBuffer;Ljava/security/cert/CertificateFactory;)Landroid/util/apk/ApkSigningBlockUtils$VerifiedProofOfRotation;
    ...
    .catch Ljava/nio/BufferUnderflowException; {:try_start_0 .. :try_end_0} :catch_14
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_13
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_0} :catch_13
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_0} :catch_13
    .catch Ljava/security/SignatureException; {:try_start_0 .. :try_end_0} :catch_13
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_0} :catch_12
    ...
    .catch Ljava/nio/BufferUnderflowException; {:try_start_1 .. :try_end_1} :catch_11
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1 .. :try_end_1} :catch_10
    .catch Ljava/security/InvalidKeyException; {:try_start_1 .. :try_end_1} :catch_10
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_1 .. :try_end_1} :catch_10
    ...
    .catch Ljava/nio/BufferUnderflowException; {:try_start_3 .. :try_end_3} :catch_14
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_3 .. :try_end_3} :catch_13
    .catch Ljava/security/InvalidKeyException; {:try_start_3 .. :try_end_3} :catch_13
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_3 .. :try_end_3} :catch_13
    .catch Ljava/security/SignatureException; {:try_start_3 .. :try_end_3} :catch_13
    .catch Ljava/security/cert/CertificateException; {:try_start_3 .. :try_end_3} :catch_12
    ...
    .catch Ljava/security/SignatureException; {:try_start_5 .. :try_end_5} :catch_d
    ...
    .catch Ljava/nio/BufferUnderflowException; {:try_start_6 .. :try_end_6} :catch_b
    ...
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_6 .. :try_end_6} :catch_a
    .catch Ljava/security/SignatureException; {:try_start_6 .. :try_end_6} :catch_a
    ...
    .catch Ljava/security/SignatureException; {:try_start_7 .. :try_end_7} :catch_7
    ...
    .catch Ljava/nio/BufferUnderflowException; {:try_start_8 .. :try_end_8} :catch_5
