...
.method public registerListener(Landroid/hardware/SensorListener;II)Z
    ...
    .end local p1    # "listener":Landroid/hardware/SensorListener;
    .end local p2    # "sensors":I
    .end local p3    # "rate":I
    .local v5, "listener":Landroid/hardware/SensorListener;
    .local v6, "sensors":I
    .local v7, "rate":I
