...
# static fields
.field public static final ON_CANCEL:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public static final ON_END:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
            "Landroid/animation/Animator$AnimatorListener;",
...
.field public static final ON_PAUSE:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
...
.field public static final ON_REPEAT:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
            "Landroid/animation/Animator$AnimatorListener;",
...
.field public static final ON_RESUME:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
            "Landroid/animation/Animator$AnimatorPauseListener;",
...
.field public static final ON_START:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
            "Landroid/animation/Animator$AnimatorListener;",
...
.field public static final ON_UPDATE:Landroid/animation/Animator$AnimatorCaller;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/animation/Animator$AnimatorCaller<",
...
.method public static synthetic lambda$static$0(Landroid/animation/Animator$AnimatorListener;Landroid/animation/Animator;Z)V
    .locals 0
...
.method public static synthetic lambda$static$1(Landroid/animation/Animator$AnimatorListener;Landroid/animation/Animator;Z)V
    .locals 0
    .param p0, "listener"    # Landroid/animation/Animator$AnimatorListener;
    .param p1, "animator"    # Landroid/animation/Animator;
    .param p2, "isReverse"    # Z
...
.method public static synthetic lambda$static$2(Landroid/animation/Animator$AnimatorPauseListener;Landroid/animation/Animator;Z)V
    .locals 0
...
.method public static synthetic lambda$static$3(Landroid/animation/Animator$AnimatorPauseListener;Landroid/animation/Animator;Z)V
    .locals 0
    .param p0, "listener"    # Landroid/animation/Animator$AnimatorPauseListener;
    .param p1, "animator"    # Landroid/animation/Animator;
    .param p2, "isReverse"    # Z
...
.method public static synthetic lambda$static$4(Landroid/animation/ValueAnimator$AnimatorUpdateListener;Landroid/animation/ValueAnimator;Z)V
    .locals 0
...
# virtual methods
.method public abstract call(Ljava/lang/Object;Ljava/lang/Object;Z)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;TA;Z)V"
        }
