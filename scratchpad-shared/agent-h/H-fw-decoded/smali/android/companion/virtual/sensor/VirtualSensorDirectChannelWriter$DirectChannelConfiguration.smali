...
# instance fields
.field private final mEventCounter:Ljava/util/concurrent/atomic/AtomicLong;

.field private final mReportToken:I

.field private final mSensorType:I

.field private final mSharedMemoryWrapper:Landroid/companion/virtual/sensor/VirtualSensorDirectChannelWriter$SharedMemoryWrapper;


# direct methods
.method constructor <init>(IILandroid/companion/virtual/sensor/VirtualSensorDirectChannelWriter$SharedMemoryWrapper;)V
    .locals 3
...
# virtual methods
.method write(Landroid/companion/virtual/sensor/VirtualSensorEvent;)V
    .locals 9
    ...
    .end local p1    # "event":Landroid/companion/virtual/sensor/VirtualSensorEvent;
    .local v6, "event":Landroid/companion/virtual/sensor/VirtualSensorEvent;
    ...
    .line 293
    :cond_0
    iget-object p1, p0, Landroid/companion/virtual/sensor/VirtualSensorDirectChannelWriter$DirectChannelConfiguration;->mEventCounter:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {p1, v7, v8}, Ljava/util/concurrent/atomic/AtomicLong;->setRelease(J)V
