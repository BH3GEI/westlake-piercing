...
.method constructor <init>(Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace$RenderIntent;)V
    ...
    .end local p1    # "source":Landroid/graphics/ColorSpace;
    .end local p2    # "destination":Landroid/graphics/ColorSpace;
    .end local p3    # "intent":Landroid/graphics/ColorSpace$RenderIntent;
    .local v2, "source":Landroid/graphics/ColorSpace;
    .local v3, "destination":Landroid/graphics/ColorSpace;
    .local v6, "intent":Landroid/graphics/ColorSpace$RenderIntent;
...
.method synthetic constructor <init>(Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace;Landroid/graphics/ColorSpace$RenderIntent;[FLandroid/graphics/ColorSpace-IA;)V
    .locals 0
