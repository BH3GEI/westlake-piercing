...
.method public enforceSlicePermission(Landroid/net/Uri;II[Ljava/lang/String;)V
    .locals 7
    .param p1, "uri"    # Landroid/net/Uri;
    .param p2, "pid"    # I
    .param p3, "uid"    # I
    ...
    .local v4, "pid":I
    .local v5, "uid":I
    .local v6, "autoGrantPermissions":[Ljava/lang/String;
    :try_start_1
    ...
    .end local v4    # "pid":I
    .end local v5    # "uid":I
    .end local v6    # "autoGrantPermissions":[Ljava/lang/String;
    .end local p0    # "this":Landroid/app/slice/SliceManager;
    throw p2
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .restart local v6    # "autoGrantPermissions":[Ljava/lang/String;
    .restart local p0    # "this":Landroid/app/slice/SliceManager;
    :catch_0
    move-exception v0
...
.method public getSliceDescendants(Landroid/net/Uri;)Ljava/util/Collection;
    ...
    .line 228
    const-string/jumbo v4, "get_descendants"
