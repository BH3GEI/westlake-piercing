...
.field public static final NOT_RUNNING:Landroid/app/time/LocationTimeZoneAlgorithmStatus;

.field public static final NOT_SUPPORTED:Landroid/app/time/LocationTimeZoneAlgorithmStatus;

.field public static final PROVIDER_STATUS_IS_CERTAIN:I = 0x3

.field public static final PROVIDER_STATUS_IS_UNCERTAIN:I = 0x4

.field public static final PROVIDER_STATUS_NOT_PRESENT:I = 0x1

.field public static final PROVIDER_STATUS_NOT_READY:I = 0x2

.field public static final RUNNING_NOT_REPORTED:Landroid/app/time/LocationTimeZoneAlgorithmStatus;


# instance fields
.field private final mPrimaryProviderReportedStatus:Landroid/service/timezone/TimeZoneProviderStatus;

.field private final mPrimaryProviderStatus:I

.field private final mSecondaryProviderReportedStatus:Landroid/service/timezone/TimeZoneProviderStatus;

.field private final mSecondaryProviderStatus:I
...
.method public constructor <init>(IILandroid/service/timezone/TimeZoneProviderStatus;ILandroid/service/timezone/TimeZoneProviderStatus;)V
    .locals 7
    .param p1, "status"    # I
...
.method private static hasProviderReported(I)Z
    .locals 1
...
.method public static parseCommandlineArg(Ljava/lang/String;)Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .locals 9
    ...
    invoke-static {v2}, Landroid/app/time/LocationTimeZoneAlgorithmStatus;->providerStatusFromString(Ljava/lang/String;)I

    move-result v5

    .line 239
    .local v5, "primaryProviderStatus":I
    nop
    ...
    invoke-static {v2}, Landroid/app/time/LocationTimeZoneAlgorithmStatus;->parseTimeZoneProviderStatusOrNull(Ljava/lang/String;)Landroid/service/timezone/TimeZoneProviderStatus;

    move-result-object v6

    .line 241
    .local v6, "primaryProviderReportedStatus":Landroid/service/timezone/TimeZoneProviderStatus;
    const/4 v2, 0x4
    ...
    .line 242
    .local v7, "secondaryProviderStatus":I
    nop
    ...
    .line 244
    .local v8, "secondaryProviderReportedStatus":Landroid/service/timezone/TimeZoneProviderStatus;
    new-instance v3, Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    ...
    .line 234
    .end local v4    # "algorithmStatus":I
    .end local v5    # "primaryProviderStatus":I
    .end local v6    # "primaryProviderReportedStatus":Landroid/service/timezone/TimeZoneProviderStatus;
    .end local v7    # "secondaryProviderStatus":I
    .end local v8    # "secondaryProviderReportedStatus":Landroid/service/timezone/TimeZoneProviderStatus;
    :cond_0
    new-instance v2, Ljava/lang/IllegalArgumentException;
...
.method private static parseTimeZoneProviderStatusOrNull(Ljava/lang/String;)Landroid/service/timezone/TimeZoneProviderStatus;
    .locals 1
...
.method public static providerStatusFromString(Ljava/lang/String;)I
    .locals 4
...
.method public static providerStatusToString(I)Ljava/lang/String;
    .locals 3
    .param p0, "providerStatus"    # I
...
.method public static requireValidProviderStatus(I)I
    .locals 3
    .param p0, "providerStatus"    # I
...
.method public getPrimaryProviderReportedStatus()Landroid/service/timezone/TimeZoneProviderStatus;
    .locals 1
...
.method public getPrimaryProviderStatus()I
    .locals 1
...
.method public getSecondaryProviderReportedStatus()Landroid/service/timezone/TimeZoneProviderStatus;
    .locals 1
...
.method public getSecondaryProviderStatus()I
    .locals 1
