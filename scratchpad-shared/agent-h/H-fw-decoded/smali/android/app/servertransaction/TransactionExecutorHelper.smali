...
# instance fields
.field private final mLifecycleSequence:Landroid/util/IntArray;
...
.method private static findNextLifecycleItemIndex(Ljava/util/List;ILandroid/os/IBinder;)I
    .locals 4
    ...
    .line 304
    .local p0, "items":Ljava/util/List;, "Ljava/util/List<Landroid/app/servertransaction/ClientTransactionItem;>;"
...
.method public static getLifecycleRequestForCurrentState(Landroid/app/ActivityThread$ActivityClientRecord;)Landroid/app/servertransaction/ActivityLifecycleItem;
    ...
    invoke-direct {v1, v2}, Landroid/app/servertransaction/StopActivityItem;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/app/servertransaction/PauseActivityItem;-><init>(Landroid/os/IBinder;)V
...
.method private static lastCallbackRequestingStateIndex(Ljava/util/List;IILandroid/os/IBinder;)I
    .locals 7
    .param p1, "startIndex"    # I
    ...
    .line 246
    .local v0, "lastRequestedState":I
    const/4 v1, -0x1

    .line 247
    .local v1, "lastRequestingCallback":I
    move v2, p2
    ...
    .end local v4    # "postExecutionState":I
    :cond_1
...
.method static shouldExcludeLastLifecycleState(Ljava/util/List;I)Z
    .locals 7
    ...
    .line 276
    .local v0, "item":Landroid/app/servertransaction/ClientTransactionItem;
    ...
    .line 284
    .local v5, "nextLifecycleItemIndex":I
    if-ne v5, v4, :cond_1
    ...
    .end local v5    # "nextLifecycleItemIndex":I
    :cond_4
    :goto_0
    return v3
.end method
