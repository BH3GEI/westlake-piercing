...
.method public static computeMinSdkVersion(ILjava/lang/String;I[Ljava/lang/String;Landroid/content/pm/parsing/result/ParseInput;)Landroid/content/pm/parsing/result/ParseResult;
    ...
    sget-object v2, Landroid/os/Build$VERSION;->KNOWN_CODENAMES:Ljava/util/Set;
    ...
    new-instance v3, Landroid/content/pm/PackageParser$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Landroid/content/pm/PackageParser$$ExternalSyntheticLambda3;-><init>()V
    ...
    const-string v1, "Parsed package requires min development platform "
...
.method public static computeTargetSdkVersion(ILjava/lang/String;[Ljava/lang/String;Landroid/content/pm/parsing/result/ParseInput;Z)Landroid/content/pm/parsing/result/ParseResult;
    ...
    new-instance v2, Landroid/content/pm/PackageParser$$ExternalSyntheticLambda3;

    invoke-direct {v2}, Landroid/content/pm/PackageParser$$ExternalSyntheticLambda3;-><init>()V
    ...
    const-string v1, "Parsed package requires development platform "
    ...
    const-string v2, "Bad package SDK"

    invoke-interface {p3, v0, v2}, Landroid/content/pm/parsing/result/ParseInput;->error(ILjava/lang/String;)Landroid/content/pm/parsing/result/ParseResult;
    ...
    .line 405
    invoke-interface {p3, v0, v1}, Landroid/content/pm/parsing/result/ParseInput;->error(ILjava/lang/String;)Landroid/content/pm/parsing/result/ParseResult;
