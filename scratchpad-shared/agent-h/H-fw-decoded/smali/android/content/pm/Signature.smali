...
.method static areEffectiveArraysMatch([Landroid/content/pm/Signature;[Landroid/content/pm/Signature;)Z
    .locals 5
...
.method public static areEffectiveMatch(Landroid/content/pm/SigningDetails;Landroid/content/pm/SigningDetails;)Z
    .locals 2
    .param p0, "a"    # Landroid/content/pm/SigningDetails;
    .param p1, "b"    # Landroid/content/pm/SigningDetails;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;
        }
...
.method static areExactArraysMatch([Landroid/content/pm/Signature;[Landroid/content/pm/Signature;)Z
    .locals 2
    .param p0, "a"    # [Landroid/content/pm/Signature;
    .param p1, "b"    # [Landroid/content/pm/Signature;
...
.method public static areExactMatch(Landroid/content/pm/SigningDetails;Landroid/content/pm/SigningDetails;)Z
    .locals 2
    .param p0, "ad"    # Landroid/content/pm/SigningDetails;
    .param p1, "bd"    # Landroid/content/pm/SigningDetails;
...
.method public static areExactMatch(Landroid/content/pm/SigningDetails;[Landroid/content/pm/Signature;)Z
    .locals 1
    .param p0, "ad"    # Landroid/content/pm/SigningDetails;
    .param p1, "b"    # [Landroid/content/pm/Signature;
    ...
    invoke-static {v0, p1}, Landroid/content/pm/Signature;->areExactArraysMatch([Landroid/content/pm/Signature;[Landroid/content/pm/Signature;)Z
...
.method public toCharsString()Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/content/pm/Signature;->mStringRef:Ljava/lang/ref/SoftReference;
...
.method public writeToXmlAttributeBytesHex(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-interface {p1, p2, p3, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->attributeBytesHex(Ljava/lang/String;Ljava/lang/String;[B)Lorg/xmlpull/v1/XmlSerializer;
