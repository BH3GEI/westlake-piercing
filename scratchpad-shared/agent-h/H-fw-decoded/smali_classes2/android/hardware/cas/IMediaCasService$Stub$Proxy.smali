...
.method public blacklist createPlugin(ILandroid/hardware/cas/ICasListener;)Landroid/hardware/cas/ICas;
    ...
    .line 219
    .end local v2    # "_status":Z
    .local v3, "_result":Landroid/hardware/cas/ICas;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 213
    .end local v3    # "_result":Landroid/hardware/cas/ICas;
    .restart local v2    # "_status":Z
    :cond_0
    :try_start_1
    new-instance v3, Landroid/os/RemoteException;
...
.method public blacklist enumeratePlugins()[Landroid/hardware/cas/AidlCasPluginDescriptor;
    ...
    .line 239
    .end local v2    # "_status":Z
    .local v3, "_result":[Landroid/hardware/cas/AidlCasPluginDescriptor;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 233
    .end local v3    # "_result":[Landroid/hardware/cas/AidlCasPluginDescriptor;
    .restart local v2    # "_status":Z
    :cond_0
    :try_start_1
    new-instance v3, Landroid/os/RemoteException;
