...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {v1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;

    move-result-object v1

    .line 139
    .local v1, "_arg0":Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 140
    invoke-virtual {p0, v1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub;->setCallback(Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;)V
    ...
    .line 129
    .end local v1    # "_arg0":Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;
    :pswitch_1
    sget-object v1, Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;

    .line 130
    .local v1, "_arg0":Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 131
    invoke-virtual {p0, v1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub;->setCorrections(Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;)V
    ...
    .line 149
    .end local v1    # "_arg0":Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;
    :goto_0
    return v2
