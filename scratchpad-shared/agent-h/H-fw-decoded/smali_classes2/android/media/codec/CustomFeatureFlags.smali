...
.method public constructor blacklist <init>(Ljava/util/function/BiPredicate;)V
    ...
    .line 16
    .local p1, "getValueImpl":Ljava/util/function/BiPredicate;, "Ljava/util/function/BiPredicate<Ljava/lang/String;Ljava/util/function/Predicate<Landroid/media/codec/FeatureFlags;>;>;"
...
.method public blacklist getFlagNames()Ljava/util/List;
    ...
    .line 226
    const-string v26, "android.media.codec.teamfood"

    const-string v27, "android.media.codec.thumbnail_block_model"
    ...
    const-string v4, "android.media.codec.codec_availability_support"

    const-string v5, "android.media.codec.codec_buffer_state_cleanup"

    const-string v6, "android.media.codec.dataspace_v0_partial"

    const-string v7, "android.media.codec.dynamic_color_aspects"

    const-string v8, "android.media.codec.hlg_editing"

    const-string v9, "android.media.codec.in_process_sw_audio_codec"

    const-string v10, "android.media.codec.in_process_sw_audio_codec_support"

    const-string v11, "android.media.codec.input_surface_throttle"

    const-string v12, "android.media.codec.large_audio_frame_finish"

    const-string v13, "android.media.codec.native_capabilites"

    const-string v14, "android.media.codec.null_output_surface"

    const-string v15, "android.media.codec.null_output_surface_support"

    const-string v16, "android.media.codec.num_input_slots"

    const-string v17, "android.media.codec.p210_format_support"

    const-string v18, "android.media.codec.region_of_interest"

    const-string v19, "android.media.codec.region_of_interest_support"

    const-string v20, "android.media.codec.rendering_depth_removal"

    const-string v21, "android.media.codec.secure_codecs_require_crypto"

    const-string v22, "android.media.codec.set_callback_stall"

    const-string v23, "android.media.codec.set_state_early"

    const-string v24, "android.media.codec.stop_hal_before_surface"

    const-string v25, "android.media.codec.subsession_metrics"
...
.method protected blacklist getValue(Ljava/lang/String;Ljava/util/function/Predicate;)Z
    ...
    .line 222
    .local p2, "getter":Ljava/util/function/Predicate;, "Ljava/util/function/Predicate<Landroid/media/codec/FeatureFlags;>;"
    iget-object v0, p0, Landroid/media/codec/CustomFeatureFlags;->mGetValueImpl:Ljava/util/function/BiPredicate;
