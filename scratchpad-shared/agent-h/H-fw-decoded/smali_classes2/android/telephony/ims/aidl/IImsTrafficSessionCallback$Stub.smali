...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/telephony/ims/aidl/IImsTrafficSessionCallback;
    ...
    check-cast v1, Landroid/telephony/ims/aidl/IImsTrafficSessionCallback;

    return-object v1

    .line 49
    :cond_1
    new-instance v1, Landroid/telephony/ims/aidl/IImsTrafficSessionCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/telephony/ims/aidl/IImsTrafficSessionCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 99
    :pswitch_0
    sget-object v2, Landroid/telephony/ims/feature/ConnectionFailureInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v2}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/telephony/ims/feature/ConnectionFailureInfo;

    .line 100
    .local v2, "_arg0":Landroid/telephony/ims/feature/ConnectionFailureInfo;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 101
    invoke-virtual {p0, v2}, Landroid/telephony/ims/aidl/IImsTrafficSessionCallback$Stub;->onError(Landroid/telephony/ims/feature/ConnectionFailureInfo;)V

    .line 102
    goto :goto_0

    .line 93
    .end local v2    # "_arg0":Landroid/telephony/ims/feature/ConnectionFailureInfo;
    :pswitch_1
