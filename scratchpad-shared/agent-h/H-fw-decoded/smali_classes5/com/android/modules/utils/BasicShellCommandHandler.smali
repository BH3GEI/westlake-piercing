...
.method public blacklist exec(Landroid/os/Binder;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;[Ljava/lang/String;)I
    ...
    .end local p1    # "target":Landroid/os/Binder;
    .end local p2    # "in":Ljava/io/FileDescriptor;
    .end local p3    # "out":Ljava/io/FileDescriptor;
    .end local p4    # "err":Ljava/io/FileDescriptor;
    .end local p5    # "args":[Ljava/lang/String;
    .local v3, "target":Landroid/os/Binder;
    ...
    .line 86
    iput-object v1, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mCmd:Ljava/lang/String;
    ...
    .local p1, "res":I
    :try_start_0
    iget-object p2, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mCmd:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lcom/android/modules/utils/BasicShellCommandHandler;->onCommand(Ljava/lang/String;)I
    ...
    .line 110
    iget-object p2, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mOutPrintWriter:Ljava/io/PrintWriter;
    ...
    .line 113
    :cond_1
    iget-object p2, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mErrPrintWriter:Ljava/io/PrintWriter;
    ...
    .line 105
    .local p3, "eout":Ljava/io/PrintWriter;
    ...
    iget-object p5, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mCmd:Ljava/lang/String;
    ...
    .end local p3    # "eout":Ljava/io/PrintWriter;
    iget-object p2, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mOutPrintWriter:Ljava/io/PrintWriter;
    ...
    .line 110
    iget-object p3, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mOutPrintWriter:Ljava/io/PrintWriter;
    ...
    .line 113
    :cond_4
    iget-object p3, v2, Lcom/android/modules/utils/BasicShellCommandHandler;->mErrPrintWriter:Ljava/io/PrintWriter;
