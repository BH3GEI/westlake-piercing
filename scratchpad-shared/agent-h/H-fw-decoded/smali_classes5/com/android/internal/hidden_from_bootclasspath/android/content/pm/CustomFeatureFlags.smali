...
.method public constructor blacklist <init>(Ljava/util/function/BiPredicate;)V
    ...
    .line 16
    .local p1, "getValueImpl":Ljava/util/function/BiPredicate;, "Ljava/util/function/BiPredicate<Ljava/lang/String;Ljava/util/function/Predicate<Lcom/android/internal/hidden_from_bootclasspath/android/content/pm/FeatureFlags;>;>;"
    ...
    const-string v50, "android.content.pm.wait_application_killed"
    ...
    const-string v33, "android.content.pm.provide_info_of_apk_in_apex"

    const-string v34, "android.content.pm.quarantined_enabled"

    const-string v35, "android.content.pm.read_install_info"

    const-string v36, "android.content.pm.recoverability_detection"

    const-string v37, "android.content.pm.reduce_broadcasts_for_component_state_changes"

    const-string v38, "android.content.pm.relative_reference_intent_filters"

    const-string v39, "android.content.pm.remove_cross_user_permission_hack"

    const-string v40, "android.content.pm.remove_hidden_module_usage"

    const-string v41, "android.content.pm.restrict_nonpreloads_system_shareduids"

    const-string v42, "android.content.pm.rollback_lifetime"

    const-string v43, "android.content.pm.sdk_dependency_installer"

    const-string v44, "android.content.pm.sdk_lib_independence"

    const-string v45, "android.content.pm.set_pre_verified_domains"

    const-string v46, "android.content.pm.stay_stopped"

    const-string v47, "android.content.pm.uid_based_provider_lookup"

    const-string v48, "android.content.pm.use_art_service_v2"

    const-string v49, "android.content.pm.use_pia_v2"

    filled-new-array/range {v2 .. v51}, [Ljava/lang/String;
...
.method public blacklist getFlagNames()Ljava/util/List;
    ...
    .line 380
    const-string v48, "android.content.pm.use_pia_v2"

    const-string v49, "android.content.pm.wait_application_killed"
    ...
    const-string v10, "android.content.pm.component_state_changed_metrics"

    const-string v11, "android.content.pm.delete_packages_silently_backport"

    const-string v12, "android.content.pm.disallow_sdk_libs_to_be_apps"

    const-string v13, "android.content.pm.emergency_install_permission"

    const-string v14, "android.content.pm.encode_app_intent"

    const-string v15, "android.content.pm.fix_duplicated_flags"

    const-string v16, "android.content.pm.fix_system_apps_first_install_time"

    const-string v17, "android.content.pm.force_multi_arch_native_libs_match"

    const-string v18, "android.content.pm.get_package_info"

    const-string v19, "android.content.pm.get_package_info_with_fd"

    const-string v20, "android.content.pm.get_package_storage_stats"

    const-string v21, "android.content.pm.get_resolved_apk_path"

    const-string v22, "android.content.pm.improve_home_app_behavior"

    const-string v23, "android.content.pm.improve_install_dont_kill"

    const-string v24, "android.content.pm.improve_install_freeze"

    const-string v25, "android.content.pm.include_feature_flags_in_package_cacher"

    const-string v26, "android.content.pm.introduce_media_processing_type"

    const-string v27, "android.content.pm.lightweight_invisible_label_detection"

    const-string v28, "android.content.pm.min_target_sdk_24"

    const-string v29, "android.content.pm.nullable_data_dir"

    const-string v30, "android.content.pm.optimize_parsing_in_registered_services_cache"

    const-string v31, "android.content.pm.package_restart_query_disabled_by_default"

    const-string v32, "android.content.pm.provide_info_of_apk_in_apex"

    const-string v33, "android.content.pm.quarantined_enabled"

    const-string v34, "android.content.pm.read_install_info"

    const-string v35, "android.content.pm.recoverability_detection"

    const-string v36, "android.content.pm.reduce_broadcasts_for_component_state_changes"

    const-string v37, "android.content.pm.relative_reference_intent_filters"

    const-string v38, "android.content.pm.remove_cross_user_permission_hack"

    const-string v39, "android.content.pm.remove_hidden_module_usage"

    const-string v40, "android.content.pm.restrict_nonpreloads_system_shareduids"

    const-string v41, "android.content.pm.rollback_lifetime"

    const-string v42, "android.content.pm.sdk_dependency_installer"

    const-string v43, "android.content.pm.sdk_lib_independence"

    const-string v44, "android.content.pm.set_pre_verified_domains"

    const-string v45, "android.content.pm.stay_stopped"

    const-string v46, "android.content.pm.uid_based_provider_lookup"

    const-string v47, "android.content.pm.use_art_service_v2"
...
.method protected blacklist getValue(Ljava/lang/String;Ljava/util/function/Predicate;)Z
    ...
    .line 376
    .local p2, "getter":Ljava/util/function/Predicate;, "Ljava/util/function/Predicate<Lcom/android/internal/hidden_from_bootclasspath/android/content/pm/FeatureFlags;>;"
