...
.method public constructor blacklist <init>(Ljava/util/function/BiPredicate;)V
    ...
    .line 16
    .local p1, "getValueImpl":Ljava/util/function/BiPredicate;, "Ljava/util/function/BiPredicate<Ljava/lang/String;Ljava/util/function/Predicate<Lcom/android/internal/hidden_from_bootclasspath/android/companion/FeatureFlags;>;>;"
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 105
    new-instance v0, Ljava/util/HashSet;

    const-string v8, "android.companion.unpair_associated_device"

    const-string v9, ""

    const-string v1, "android.companion.association_device_icon"

    const-string v2, "android.companion.association_failure_code"

    const-string v3, "android.companion.association_tag"

    const-string v4, "android.companion.device_presence"

    const-string v5, "android.companion.new_association_builder"

    const-string v6, "android.companion.ongoing_perm_sync"

    const-string v7, "android.companion.perm_sync_user_consent"
...
# virtual methods
.method public blacklist associationDeviceIcon()Z
    .locals 2
...
.method public blacklist associationFailureCode()Z
    .locals 2

    .line 29
    new-instance v0, Lcom/android/internal/hidden_from_bootclasspath/android/companion/CustomFeatureFlags$$ExternalSyntheticLambda7;

    invoke-direct {v0}, Lcom/android/internal/hidden_from_bootclasspath/android/companion/CustomFeatureFlags$$ExternalSyntheticLambda7;-><init>()V

    const-string v1, "android.companion.association_failure_code"
...
.method public blacklist getFlagNames()Ljava/util/List;
    ...
    const-string v0, "android.companion.association_device_icon"

    const-string v1, "android.companion.association_failure_code"

    const-string v2, "android.companion.association_tag"
